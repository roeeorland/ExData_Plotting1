...
plot(hpc$date_time,hpc$Voltage,type = "n", xlab = "datetime", ylab = "Voltage")#, ylim = c(0,38))
...
legend("topright",lty=1,col=c("black", "red", "blue"), c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), seg.len = 0.5, xjust = 0)


#bottom right
hpc$Global_reactive_power=as.numeric(as.character(hpc$Global_reactive_power))
plot(hpc$date_time,hpc$Global_reactive_power,type = "n", xlab = "datetime", ylab = names(hpc$Global_reactive_power))#, ylim = c(0,38))
